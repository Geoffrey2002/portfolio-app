    ...
    <div id="home" className="w-full min-h-screen text-center pt-20 md:pt-36 px-4 pb-10 md:pb-20">
      <div className="max-w-[1240px] w-full mx-auto p-2 flex justify-center items-center">
        <Card className="w-full bg-[--color-bg-card] border-[--color-border] p-6 md:p-8 lg:p-12 rounded-2xl">
          ...
          >
            <div className="px-4 md:px-6 py-2 md:py-3 rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <span className="text-lg md:text-2xl font-bold text-white">4+</span>
              <span className="text-xs md:text-sm text-white/90 ml-1 md:ml-2">Years Experience</span>
            </div>
            <div className="px-4 md:px-6 py-2 md:py-3 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <span className="text-lg md:text-2xl font-bold text-white">15+</span>
              <span className="text-xs md:text-sm text-white/90 ml-1 md:ml-2">Projects Completed</span>
            </div>
            <div className="px-4 md:px-6 py-2 md:py-3 rounded-full bg-gradient-to-r from-pink-500 to-amber-500 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <span className="text-lg md:text-2xl font-bold text-white">8+</span>
              <span className="text-xs md:text-sm text-white/90 ml-1 md:ml-2">Technologies</span>
            </div>
          </motion.div>
          ...
          <motion.div
            variants={fadeInUp}
            className="flex flex-wrap gap-3 md:gap-4 justify-center py-4 md:py-6"
          >
            <Link href="/#projects">
            ...
            <Link href="/#contact">
              <Button size="lg" variant="outline" className="text-sm md:text-base px-6 md:px-8 bg-transparent border-2 border-[--color-primary] text-[--color-primary] hover:bg-[--color-primary] hover:text-white">
                Get In Touch
              </Button>
            </Link>
          </motion.div>
          ...
          <motion.div
            variants={staggerContainer}
            className="flex items-center justify-center gap-4 md:gap-6 max-w-[400px] m-auto py-4 flex-wrap"
          >
            {socialLinks.map((social) => {
              ...
              const linkContent = (
                <motion.div
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="rounded-full shadow-lg shadow-black/20 p-4 md:p-5 cursor-pointer bg-[--color-bg-card] hover:bg-gradient-to-r hover:from-[--color-primary] hover:to-[--color-primary-light] transition-all duration-300 group min-h-[52px] min-w-[52px] md:min-h-[60px] md:min-w-[60px] flex items-center justify-center border border-[--color-border]"
                >
