    ...
    <>
      ...
      <div className="max-w-[940px] mx-auto p-2 pt-[120px]">
        ...
        <div className="bg-[#d0d4d6] my-4 p-4 w-full flex justify-between items-center">
          <h2 className="text-center">Geoffrey Muthoni</h2>
          <div className="flex">
            <a
        ...
        <div className="py-6">
          <p className="italic">
            <span className="font-bold italic">Jendie Procab Ltd.</span>
            <span className="px-2">|</span>Ngara, Nairobi
          </p>
          <p className="py-1 italic">Front-End Developer (2022 - Current)</p>
