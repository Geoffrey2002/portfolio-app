      ...
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2">
          ...
          <p className="py-2 text-gray-600">
            ...
            beautiful and functional websites.I am passionate about crafting clean and functional websites.Over the past 4 years, I have dedicated myself to mastering coding. I have always had a knack for technology
            ...
            operating.What started as minor edits quickly grew into a deep passion for programming.
          </p>
          <p className="py-2 text-gray-600">
            Fascinated with how intricate programming can be I was quickly drawn
            to learn more. I started learning javascript and was even more
            enthused with making websites interactive. I am now spending my time
            building projects with React JS, Supabase and learning new
            technologies.
          </p>
          <Link href="/#projects">
